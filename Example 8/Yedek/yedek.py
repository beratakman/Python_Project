...
for listedFunctions in functionClasses: # fonksiyon isimleri yazan listenin içinden tek tek o listeleri
    ...
    for oneFunction in listedFunctions: # ardındanda aldığımız listelerin içindeki fonksiyonları ayrıyoruz
            print(oneFunction)