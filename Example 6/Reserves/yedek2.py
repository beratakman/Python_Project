...
entrance0 = input("E-Okula Hoşgeldiniz Lütfen Hangi İşlemi Yapıcağınızı Girin\n(Devamsızlık, Ders Programı, Sınav Sonucu Öğrenme):\n")
entrance = entrance0.title()

if entrance == "Devamsızlık":
    print("Şuanda Boş, Lütfen Yeni Okul Yılında Tekrar Deneyin")
    exit()
elif entrance == "Ders Programı":
    print("Şuanda Boş, Lütfen Yeni Okul Yılında Tekrar Deneyin")
    exit()
elif entrance == "Sınav Sonucu Öğrenme":
...
print("Giriş Başarılı Lütfen Bekleyin", time.sleep(4))
...
print("Lütfen Biraz Bekleyin, Notunuz Hesaplanıyor", time.sleep(7))
...
randomNumber7 = random.randint(11,50000)

#################################################################################

randomNumber8 = random.randint(50001,75001)
randomNumber9  = random.randint(11,15000)
